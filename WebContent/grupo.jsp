...
<jsp:include page="menuSide2.jsp">
	<jsp:param name="titulo" value="Alta Grupo" />
</jsp:include>
<%
...
<center><h1>&Uacute;ltimos registros agregados</h1>
<script src="./js/jquery-ui-1.12.1.custom/external/jquery/jquery.js"></script>
<script src="./js/jquery-ui-1.12.1.custom/jquery-ui.js"></script>
<iframe id="listado" src="./grupo_listadoUltimos.jsp" style="min-width:800px; width:90%;" frameborder="0"></iframe>
</center>
<script>
$('#guarda').button();
$('#guarda-icon').button({
