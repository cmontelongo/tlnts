...
<table style="width:'85%'; min-width:800px" align="center" cellspacing="15px" border="0">
	...
	<tr>
		...
		<td>
			<input id="tallaId" type="hidden" />
			<input id="talla" title="type &quot;a&quot;" style="width:200px" />
		</td>
	</tr>
	<tr>
		<td colspan="2">
...
<iframe id="listado" src="./prodAlmacen_listadoUltimos.jsp" style="min-width:800px; width:90%;" frameborder="0"></iframe>
</center>
...
var productoDisponible = <%= productoAction.obtenerProductoJson() %>;
