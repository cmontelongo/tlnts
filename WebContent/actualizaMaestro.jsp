...
<jsp:include page="menuSide2.jsp">
	<jsp:param name="titulo" value="Actualizar Maestros" />
</jsp:include>
<div id="columns1"></div>
...
$.ajax({
    ...
    success: function(json) {
	    $('#columns1').columns({
	        ...
	        schema: [
                {"header":"ID", "key":"id"},
                {"header":"Nombe", "key":"nombre"},
                {"header":"Activo", "key":"estatus"},
                {"header":"Clases", "key":"clases"},
...
var consulta = function(id){
	var contenido = $.get("/grupoServlet?m="+id+"&p=c&c=3&d=1", function(data, status){
		$("#templates").html(data);
		$( "#dialog" ).dialog( "open" );
