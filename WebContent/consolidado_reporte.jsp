	...
	<tr>
		<td>
			...
			<select name="selConcepto" id="selConcepto">
				...
				<option id="4" value="4">Concentrado</option>
			</select>
		</td>
		<td>
			<fieldset>
...
$(document).ready(function() {
	...
	$('#reporte').click(function(event) {
		...
		console.log(sel);
		if (sel == 1){
			$("#listado").attr("src", "./pago_reporteCorte.jsp?opc="+opc+"&dia="+dia+"&mes="+mes+"&anio="+anio);
		} else if (sel == 2) {
			$("#listado").attr("src", "./pagoEvento_reporte.jsp?opc="+opc+"&dia="+dia+"&mes="+mes+"&anio="+anio+"&sel="+sel+"&e="+eventoId+"&c="+conceptoId);
		} else if (sel == 3) {
			$("#listado").attr("src", "./paqueteVenta_reporte.jsp?opc="+opc+"&dia="+dia+"&mes="+mes+"&anio="+anio+"&sel="+sel+"&e="+eventoId+"&c="+conceptoId);
		}
