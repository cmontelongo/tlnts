...
<title>Talentos - Alta de Producto</title>
	<link href="./js/jquery-ui-1.12.1.custom/jquery-ui.css" rel="stylesheet">
</head>
<body>
<jsp:include page="menuSide2.jsp">
	<jsp:param name="titulo" value="Alta Producto" />
</jsp:include>
<%
...
<table style="width:'85%'; min-width:800px" align="center" cellspacing="15px" border="0">
	...
	<tr>
		...
		<td>
			<input id="descripcion" style="width:200px" />
		</td>
		<td>
...
<iframe id="listado" src="./producto_listadoUltimos.jsp" style="min-width:800px; width:90%;" frameborder="0"></iframe>
</center>
