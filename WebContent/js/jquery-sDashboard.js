		...
		$.widget("mn.sDashboard", {
			...
			_constructWidget : function(widgetDefinition) {
				...
				if (widgetDefinition.widgetType === 'table') {
					...
					var dataTable = $('<table style="width:100%" cellpadding="0" cellspacing="0" border="0" class="display sDashboardTableView table table-bordered"></table>').dataTable(tableDef);
