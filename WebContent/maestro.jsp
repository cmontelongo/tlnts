...
<jsp:include page="menuSide2.jsp">
	<jsp:param name="titulo" value="Alta Maestro" />
</jsp:include>
<%
...
%>
<br />
<table style="width:25%; margin-top:25px;" align="center">
	<tr>
		<td>
			Maestro
		</td>
...
<iframe id="listado" src="./maestro_listadoUltimos.jsp" style="min-width:800px; width:90%;" frameborder="0"></iframe>
</center>
<script>
$('#guarda').button();
$('#guarda-icon').button({
