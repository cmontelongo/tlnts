...
<table style="85%" align="center">
	...
	<tr>
		...
		<td>
			<input type="text" id="monto" value="" style="font-size:25px; font-family: Times new Roman" />
		</td>
		<td>
...
<iframe id="listado" src="./clases_listadoUltimos.jsp" style="min-width:800px; width:100%;" frameborder="0"></iframe>
</center>
<script>
$('#guarda').button();
$('#guarda-icon').button({
...
$( "#clase" ).autocomplete({
    ...
    select: function (event, ui) {
        $("#hInicio").val(ui.item.hInicio); // display the selected text
        $("#hFin").val(ui.itemhFin); // save selected id to hidden input
        console.log(ui.item.diaS);
        console.log(ui.item.id+" - "+ui.item.label+" - "+ui.item.monto+" - "+ui.item.hInicio+"/"+ui.item.hFin);
    }
});
